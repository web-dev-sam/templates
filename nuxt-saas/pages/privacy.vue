...
<template>
  <div>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          &quot;Our&quot; in this Agreement) refers to Webry SaaS Template.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          <a href="https://saas-template.webry.com/" rel="external nofollow noopener" target="_blank"
            >https://saas-template.webry.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>To provide You</strong> with news, special offers and general information about other goods, services
